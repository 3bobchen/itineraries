...
export const ITINERARIES: Itinerary[] = [
  ...
  {
    slug: 'andorra-in-a-day',
    title: 'Andorra in a day',
    city: 'Andorra la Vella',
    country: 'Andorra',
    tagline: 'A long day trip driving from Barcelona into the Pyrenees — panoramic valley views, a walk through the capital, and spectacular high-altitude bridges and platforms.',
    intro: 'I stayed in Barcelona and rented a car for the four-hour drive north through Catalonia and into Andorra. It was a fast-paced day trip focused on mountain roads and panoramic valley lookouts, returning to Spain before nightfall.',
    hero: {
      srcBase: 'and-hero-valley-view',
      width: 1024,
      height: 768,
      alt: 'Panoramic view of the Andorra la Vella valley and surrounding Pyrenees peaks from the Mirador de la Comella road under cloudy skies',
      caption: 'Looking down over Andorra la Vella from the La Comella overlook.',
    },
    stats: {
      days: 1,
      pace: 'full',
    ...
    days: [
      {
        slug: 'the-day',
        number: 1,
        title: 'Valleys, bridges, and mountain viewpoints',
        summary: 'An early morning drive from Barcelona to the Mirador de la Comella lookout, down into Andorra la Vella for shopping and lunch, up to Canillo to cross the suspension Tibetan Bridge, and a final stop at the Roc del Quer platform before driving back to Barcelona.',
        walkingKm: 3,
        image: {
          srcBase: 'and-day1-roc-del-quer',
          width: 1706,
          height: 1279,
          alt: 'Panoramic mountain view from the Roc del Quer platform extending over the Pyrenees valleys under autumn clouds',
          caption: 'Mountain ranges stretching to the horizon from the Roc del Quer viewpoint.',
        },
        entries: [
          {
            kind: 'stop',
            stop: {
              time: '12:43',
              title: 'Mirador de la Comella',
              body: 'The drive from Barcelona took about three hours, winding past the Montserrat massif and crossing the border at La Seu d\'Urgell. Mirador de la Comella was my first stop in Andorra, a roadside pull-off offering a wide view over the capital city huddled in the deep valley below.',
            },
          },
          {
            kind: 'stop',
            stop: {
              time: '14:15',
              title: 'Plaça de la Rotonda and Avinguda Meritxell',
              body: 'I drove down into Andorra la Vella and parked near the tourist office. I walked across the Pont de París, saw Salvador Dalí\'s \'La Noblesse du Temps\' sculpture in Plaça de la Rotonda, and grabbed a quick fast-food lunch along Avinguda Meritxell, the city\'s main shopping street.',
              image: {
                srcBase: 'and-stop-meritxell-bridge',
                width: 1024,
                height: 768,
                alt: 'The clear water of the Valira River channeled between concrete banks and under pedestrian bridges in central Andorra la Vella',
                caption: 'The Valira River running through the center of Andorra la Vella.',
              },
            },
          },
          {
            ...
            stop: {
              time: '16:03',
              title: 'Pont Tibetà de Canillo',
              body: 'The road climbs steeply from the capital up toward Canillo and the CS-240 mountain pass. The Pont Tibetà is a massive, narrow steel suspension bridge stretching over six hundred meters across the Vall del Riu gorge, hanging high above the valley floor.',
              image: {
                srcBase: 'and-stop-tibetan-bridge',
                width: 768,
                height: 1024,
                alt: 'The suspension Tibetan Bridge of Canillo stretching across the valley between green pine-covered slopes under clouds',
                caption: 'Looking down the length of the Tibetan Bridge.',
              },
            },
          },
          {
            ...
            stop: {
              time: '16:23',
              title: 'Mirador Roc del Quer',
              body: 'A short drive further along the Carretera de Montaup brought me to the Roc del Quer viewpoint. A steel platform projects twelve meters out over the sheer drop, with a bronze statue of a thinker sitting at the very edge looking down onto the tiny towns below.',
            },
          },
        ],
      },
  ...
  },
  {
    ...
    hero: {
      srcBase: 'cal-hero-tunnel-view',
      width: 1024,
      height: 768,
      alt: 'Panoramic view of Yosemite Valley from Tunnel View, with El Capitan on the left, Bridalveil Fall on the right, and Half Dome in the distance under a blue sky',
      caption: 'The classic Tunnel View lookout, late afternoon.'
    },
    stats: {
      days: 4,
      pace: 'full',
    ...
    days: [
      {
        slug: 'day-1',
        number: 1,
        title: 'Sierras and Valley Views',
        summary: 'Driving east from San Francisco past Berkeley and entering Yosemite Valley via Big Oak Flat, stopping under the massive face of El Capitan, walking through Tunnel View, and watching the sunset at Curry Village before crossing the pass to stay in Mammoth Lakes.',
        walkingKm: 5,
        mapGrouping: [['08:06'], ['14:54', '15:19', '17:15'], ['18:21']],
        image: {
          srcBase: 'cal-day1-yosemite-valley',
          width: 1706,
          height: 1279,
          alt: 'Tall pine trees in Yosemite Valley with the face of Half Dome rising behind them in the late afternoon sun',
          caption: 'Half Dome from the valley floor.'
        },
        entries: [
          {
            kind: 'stop',
            stop: {
              ...
              body: 'A quick morning walk through the campus of the University of California, Berkeley. Sather Gate stands at the end of Telegraph Avenue, leading into the leafy paths near Sproul Plaza.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'Standing in the valley meadow directly below the massive 3,000-foot granite nose. Climbers were visible as tiny specks on the sheer nose route.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '15:19',
              title: 'Tunnel View',
              body: 'The classic entry panorama looking east into the valley as shadows start to climb the walls.',
              image: {
                srcBase: 'cal-hero-tunnel-view',
                width: 1024,
                height: 768,
          ...
          },
          {
            ...
            stop: {
              time: '17:15',
              title: 'Curry Village',
              body: 'Located at the eastern end of Yosemite Valley under Glacier Point. The historic camp has a mix of canvas tents and wooden cabins, and the deck outside the pavilion is a good spot to sit under Half Dome as the light fades.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '18:21',
              title: 'El Portal',
              body: 'A quick pause along the Merced River before heading over the Sierra crest to Mammoth Lakes.'
            }
          }
        ]
      },
      {
        slug: 'day-2',
        number: 2,
        title: 'Over the Pass to the Sand Dunes',
        summary: 'Crossing Tioga Pass through Mammoth Lakes and Bishop, entering Death Valley past Panamint Springs, exploring Mesquite Flat Sand Dunes, Salt Creek, and Furnace Creek, before watching the sunset at Zabriskie Point and Badwater Basin, staying in Ridgecrest.',
        walkingKm: 6,
        mapGrouping: [['10:06', '10:43'], ['13:53', '14:32'], ['15:54', '16:18', '17:16', '17:29'], ['19:51']],
        image: {
          srcBase: 'cal-day2-badwater',
          width: 1706,
          height: 1279,
          alt: 'The flat, white salt crust hexagons of Badwater Basin stretching to the horizon under a soft pink sunset sky',
          caption: 'The salt flats of Badwater Basin at sunset.'
        },
        entries: [
          {
            kind: 'stop',
            stop: {
              time: '10:06',
              title: 'Minaret Vista',
              body: 'After crossing the Sierra crest at Tioga Pass, the road drops into the Eastern Sierra. Minaret Vista offers a wide view of the jagged volcanic peaks of the Ritter Range and the Ansel Adams Wilderness.',
              image: {
                srcBase: 'cal-stop-mammoth-lakes',
                width: 1024,
                height: 768,
                alt: 'The rugged peaks of the Minarets rising in the distance behind green pine forests under a clear blue sky',
                caption: 'The Ritter Range from Minaret Vista.'
              }
            }
          },
          {
            ...
            stop: {
              time: '10:43',
              title: 'Bishop',
              body: 'The primary hub of the Owens Valley, situated between the Sierra Nevada and the White Mountains. A quick stop for coffee and bread at Erick Schat\'s Bakkery before heading south on US-395.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '13:53',
              title: 'Father Crowley Vista Point',
              body: 'Also known as Star Wars Canyon, this overlook sits at the western entrance of Death Valley. The view looks down into the barren Panamint Valley, and if you are lucky, military jets will scream through the canyon below the rim.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'The dunes rise nearly 100 feet from the valley floor near Stovepipe Wells. Walking out into the sand is slow, but the ripples in the dunes are cleanest if you walk away from the main footprint trails.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'The main visitor center for Death Valley National Park. The outdoor digital thermometer is the standard photo stop, showing the valley\'s extreme heat even in late autumn.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'The yellow and brown badlands at Zabriskie Point are carved from the ancient Furnace Creek Lake bed. The view towards Manly Beacon is sharpest in the late afternoon when the shadows define the ridges.',
              image: {
                srcBase: 'cal-stop-zabriskie',
                width: 1024,
                height: 576,
                alt: 'The golden, eroded clay badlands of Zabriskie Point under a clear blue sky, with Manly Beacon rising in the center',
                caption: 'The badlands at Zabriskie Point.'
              }
            }
          },
          {
            ...
            stop: {
              ...
              body: 'The most famous stop on Artist\'s Drive. Volcanic deposits have colored the clay hillsides with green, pink, and purple mineral hues, looking brightest under direct late afternoon light.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'The lowest point in North America at 282 feet below sea level. The salt flats stretch for miles — walking out onto the hexagonal salt crusts feels like walking on ice, surrounded by the towering Black Mountains.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'Leaving Death Valley, the road passes the bizarre tufa spires of the Trona Pinnacles. These calcium carbonate towers rose from the ancient Searles Lake bed and now stand isolated in the Mojave desert.'
            }
          }
        ]
      },
      {
        slug: 'day-3',
        number: 3,
        title: 'Desert Highway to the Pacific',
        summary: 'Driving through the Mojave desert towns of Ridgecrest and Inyokern, past Santa Clarita, and entering Los Angeles for views of the Hollywood Sign, Griffith Observatory, Beverly Hills, UCLA, Venice Beach, and Santa Monica Pier before driving to Morro Bay.',
        walkingKm: 6,
        mapGrouping: [['10:51'], ['14:48', '15:36'], ['17:08', '18:10'], ['19:13', '20:20']],
        image: {
          srcBase: 'cal-day3-griffith',
          width: 1706,
          height: 1279,
          alt: 'The three copper domes of Griffith Observatory lit by the afternoon sun, with the city of Los Angeles visible in the haze below',
          caption: 'Griffith Observatory looking out over Los Angeles.'
        },
        entries: [
          {
            kind: 'stop',
            stop: {
              time: '10:51',
              title: 'Ridgecrest',
              body: 'A morning stop in this Mojave desert town. It is the last major services hub before the long drive south through the Antelope Valley towards the Los Angeles basin.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '14:48',
              title: 'Hollywood Sign Vista',
              body: 'A view of the Hollywood Sign from the trailheads in Griffith Park. The sign sits high on Mount Lee, visible across the dry chaparral of the hillsides.',
              image: {
                srcBase: 'cal-stop-hollywood-sign',
                width: 1024,
                height: 768,
                alt: 'The white letters of the Hollywood Sign visible on the brown hills of Mount Lee under a hazy blue sky',
                caption: 'The Hollywood Sign from the trail below.'
              }
            }
          },
          {
            ...
            stop: {
              ...
              body: 'The Art Deco observatory sits on the south-facing slope of Mount Hollywood. The lawn offers a panoramic view of the Los Angeles basin all the way to the Pacific, with the three copper domes anchoring the building.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '17:08',
              title: 'Beverly Hills',
              body: 'A walk along Rodeo Drive and the palm-lined streets of Beverly Hills. The boutiques and manicured parks are quiet in the late afternoon.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '18:10',
              title: 'UCLA Campus',
              body: 'A evening walk through the campus of the University of California, Los Angeles in Westwood. The brick Romanesque buildings of Royce Hall and Powell Library frame the central quad.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '19:13',
              title: 'Venice Beach',
              body: 'The Venice boardwalk is quieter after dark, but the neon signs of the skatepark and the ocean breeze still carry the neighborhood\'s energy.'
            }
          },
          {
            kind: 'stop',
            stop: {
              ...
              body: 'The end of the road. The historic wooden pier marks the end of Route 66, with its neon-lit Ferris wheel spinning over the dark Pacific waves.'
            }
          }
        ]
      },
      {
        slug: 'day-4',
        number: 4,
        title: 'The Central Coast and Silicon Valley',
        summary: 'Starting with a morning view of Morro Rock, driving north through Silicon Valley to visit Apple Park, Googleplex, and Stanford University, before crossing the Bay Bridge back to San Francisco and SFO Airport for the flight home.',
        walkingKm: 4,
        mapGrouping: [['09:58'], ['14:07', '14:44', '15:14'], ['17:49', '19:58']],
        image: {
          srcBase: 'cal-day4-morro-bay',
          width: 1706,
          height: 1279,
          alt: 'Morro Rock from the harbor front.',
          caption: 'Morro Rock from the harbor front.'
        },
        entries: [
          {
            kind: 'stop',
            stop: {
              time: '09:58',
              title: 'Morro Bay',
              body: 'A morning walk along the harbor, watching the massive 576-foot volcanic plug of Morro Rock rise through the marine layer.',
              image: {
                srcBase: 'cal-stop-morro-bay',
                width: 768,
                height: 1024,
                alt: 'The massive Morro Rock rising from the ocean under a soft morning mist, seen from the bay harbor',
                caption: 'Morro Rock from the harbor front.'
              }
            }
          },
          {
            ...
            stop: {
              ...
              body: 'Looking out over the oak trees towards the main circular campus from the visitor center\'s roof terrace in Cupertino.'
            }
          },
          {
            kind: 'stop',
            stop: {
              time: '14:44',
              title: 'Googleplex',
              body: 'Walking through the open plazas and colorful bicycle pathways at the Google headquarters in Mountain View.',
              image: {
                srcBase: 'cal-stop-google-campus',
                width: 768,
                height: 1024,
                alt: 'The colorful Google logo sign sitting on a manicured lawn in front of green trees at Google headquarters',
                caption: 'The iconic Google sign at the Mountain View headquarters.'
              }
            }
          },
          {
            ...
            stop: {
              ...
              body: 'Walking the main quad sandstone arches under a clear afternoon sky.',
              image: {
                srcBase: 'cal-stop-stanford',
                width: 768,
                height: 1024,
                alt: 'The Romanesque sandstone arches of Stanford University\'s Main Quad looking towards the Memorial Church',
                caption: 'Sandstone arches on the Stanford campus.'
              }
            }
          },
          {
            ...
            stop: {
              time: '17:49',
              title: 'Bay Bridge & Yerba Buena Island',
              body: 'Crossing the double-decker span with views of the San Francisco skyline at sunset.'
            }
          },
          {
            kind: 'stop',
